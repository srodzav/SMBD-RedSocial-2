...
public class Menu extends javax.swing.JFrame {
    ...
    public Menu(String usuario, String contra) {
        ...
        this._contra = contra;
        initComponents();
        // Compara si es usuario o moderador
    ...
    private void jButton12ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton12ActionPerformed
        JFrame consulta1 = new Consulta1();
        consulta1.setVisible(true);
        consulta1.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
        consulta1.setSize(new Dimension(600,500));
    }//GEN-LAST:event_jButton12ActionPerformed

    private void jButton13ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton13ActionPerformed
        JFrame consulta2 = new Consulta2();
        consulta2.setVisible(true);
        consulta2.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
        consulta2.setSize(new Dimension(600,500));
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Menu("Usuario","admin").setVisible(true);
            }
        });
    }
